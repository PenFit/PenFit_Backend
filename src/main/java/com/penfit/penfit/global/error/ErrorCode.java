...
/**
 * 에러 코드 규칙: {도메인 2자리}{HTTP 상태 3자리}{일련번호 1자리}
 * 예) FP4041 = 금융정보(FP) + 404 + 1번
 * <p>
 * 도메인 접두어
 * CM 공통 / AU 인증 / US 사용자 / FP 금융정보 / PS 가상 연금 설정 / RH 리허설
 * PP 연금 패스포트 / PN 연금계획 / PR 상품 추천 / BM 행동 미션 / AI AI 서버 연동
 */
@Getter
